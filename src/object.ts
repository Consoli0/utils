export const patch = <T1 extends { [name: string]: any }, T2 extends { [name: string]: any }>(
  source: T1,
  destination: T2
): T1 & T2 => Object.assign(destination, source);
...
export const stripExtraEntries = <T extends { [name: string]: any }>(
